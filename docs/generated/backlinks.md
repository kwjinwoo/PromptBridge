---
id: generated-backlinks
title: Generated Backlinks
type: generated
status: active
authority: derived
relations:
...
Backlinks are derived from forward relations. Canonical documents must not add a
duplicate reverse edge solely to appear in this list.
...
| `prompt-pipeline` | Product Invariants, Protected Elements, System Overview, Preservation Validator, Clipboard State Machine, Failure Policy, Phase 3 |
| `preservation-validator` | Product Invariants, Protected Elements, System Overview, Prompt Pipeline, Phase 2, Phase 5, Evaluation Methodology |
| `clipboard-state-machine` | Product Invariants, System Overview, Failure Policy, Privacy Boundary, Phase 3, Application Compatibility |
| `failure-policy` | Product Invariants, Preservation Validator, Phase 2 |
| `privacy-boundary` | Product Invariants, Local-First Decision |
| `evaluation-methodology` | Privacy Boundary, Local Model Comparison, Phase 5 |
...
machine-readable index maps stable document IDs to their current paths.
